    ...
    <Box pos='fixed' w={{ base: 'full' }}>
      <Flex
        ...
        <Stack
          ...
          direction={'row'}
          spacing={12}>
          <Button color={useColorModeValue('gray.600', 'gray.200')} 
          as={'a'} fontSize={'sm'} fontWeight={600} variant={'link'} href={'/login'}>
            Login
          </Button>
          <Button
            as={'a'}
          ...
          <Popover trigger={'hover'} placement={'bottom-start'}>
            ...
            {navItem.children && (
              <PopoverContent
                ...
                minW={'sm'}
                w={{base: 'full'}}>
                <Stack h='50px' direction={'row'} w={{base: '100%', md: '100%'}}>
...
const MobileNav = () => {
  return (
    <Stack w={'width: 100%'} h={'100%'} bg={useColorModeValue('white', 'gray.800')} p={4} display={{ md: 'none' }}>
      {NAV_ITEMS.map((navItem) => (
